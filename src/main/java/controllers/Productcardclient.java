...
public class Productcardclient {
    ...
    public void remplireData(Product c) {
        product = c; //nstha9ha bch n3abi l cours fl refresh nst7a9ha fl modif w supp
    ...
    public void modifierProduit(ActionEvent actionEvent) {
        if(onChangeListener!=null){
            onChangeListener.onModdifierClicked(product);
        }

    }

    public void supprimerProduit(ActionEvent actionEvent) {
        sp.delete(product.getIdP());  //lazm n3ayt ll refrsh (static|instance)
        if(onChangeListener!=null){
